      ...
      <div className="max-w-7xl mx-auto px-6 md:px-12">
        ...
        <div className="flex items-center justify-between h-20">
          ...
          <div className="hidden md:flex items-center space-x-8">
            ...
            <a
              href="https://github.com/mugni-labiib" 
              target="_blank"
              rel="noopener noreferrer"
              className="flex items-center gap-2 px-4 py-2 bg-slate-800 hover:bg-slate-700 text-slate-300 hover:text-white border border-slate-700 hover:border-cyan-400 rounded-lg transition-all font-medium group"
            >
              <svg 
